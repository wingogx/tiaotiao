    ...
    modal.innerHTML = `
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-md">
                    <strong>状态：</strong>
                    <select id="taskStatus" class="form-control" onchange="updateTaskStatus('${task.id}', this.value)">
                ...
                <div class="mb-md">
                    <strong>负责人：</strong> ${task.assignee}
                </div>
                <div class="mb-md">
                    <strong>截止日期：</strong> ${task.dueDate}
                </div>
                <div class="mb-md">
...
function getFilteredTasks() {
    ...
    if (taskFilter.assignee !== 'all') {
        tasks = tasks.filter(t => t.assignee === taskFilter.assignee);
    }
