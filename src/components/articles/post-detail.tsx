...
export function PostDetail({ post, canViewContent }: { post: DailyPost; canViewContent: boolean }) {
  return (
      ...
      <Card className="overflow-hidden rounded-[36px] p-0">
        <div className="grid gap-8 p-6 md:p-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="space-y-6">
            ...
            <div className="relative min-h-[340px] overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#0d5d4f,#173d33)]">
              {post.cover_url ? (
          ...
          <div className="rounded-[30px] border border-[var(--border)] bg-white/72 p-6 md:p-8">
            {canViewContent ? (
